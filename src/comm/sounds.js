...
const SOUND_DEFS = [
  ...
  // 法国赌神
  [301, 'f_1', 80000, 1000, '法国赌神', '给我擦皮鞋'],
  [302, 'f_2', 81000, 1000, '法国赌神', '我要验牌'],
  [303, 'f_3', 82000, 1000, '法国赌神', '牌没有问题'],
  //卢本伟nb
  [401, 'l_1', 84000, 3500, '卢本伟nb', '登登登登登'],
  [402, 'l_2', 87500, 4000, '卢本伟nb', '赌怪'],
  [403, 'l_3', 91500, 8000, '卢本伟nb', '当年陈刀仔...'],
  [404, 'l_4', 99500, 2500, '卢本伟nb', '阿姨你快点啊，阿姨'],
  [405, 'l_5', 120000, 2500, '卢本伟nb', '给阿姨倒一杯卡布奇诺'],
  [406, 'l_6', 122500, 4000, '卢本伟nb', '17张牌你能秒我'],
  [407, 'l_7', 126500, 2000, '卢本伟nb', '全体起立'],
  [408, 'l_8', 128500, 2500, '卢本伟nb', '今天不是你死就是我亡'],
  [409, 'l_9', 131000, 6000, '卢本伟nb', '得得得得得得'],
]
